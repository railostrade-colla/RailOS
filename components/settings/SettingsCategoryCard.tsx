...
/**
 * Phase 14.13 Unified UI Part 2 — one row in a vertical settings list.
 * iOS-Settings / Notion style: colored icon tile + title + subtitle +
 * chevron. Uses bg-white/[0.05] so the global Part-1 shadow system
 * gives it depth + a hover lift automatically. Colors are passed as
 * raw hex (inline style) so Tailwind's JIT can't purge them.
 */
