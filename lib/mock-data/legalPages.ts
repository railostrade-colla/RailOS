...
## 5. الرسوم
- كل رسوم المنصّة تُحسب بـ **وحدات الرسوم** فقط — لا يوجد أي خصم من الحصص.
- عمولة 2% على كل صفقة شراء/بيع (وحدات رسوم)
- رسوم إنشاء الإعلانات (1.5%) — وحدات رسوم
- رسوم إنهاء العقد (0.10%) — وحدات رسوم
